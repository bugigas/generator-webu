...
<head>
    ...
    <meta name="rights" content="DEEP VISION s.r.o."/>
    <meta name="copyright" content="DEEP VISION s.r.o."/>
...
<?php foreach ($content as $cont) { ?>
    ...
    <nav class="navbar navbar-light navbar-expand-md navbar navbar-expand-lg fixed-top" id="mainNav">
        ...
        <div class="collapse navbar-collapse w-100 order-1 order-md-0" id="navbarResponsive">
        ...
        <div class="mx-auto order-0">
            <a class="navbar-brand mx-auto js-scroll-trigger" href="#home" title="Logo Best Kebab">
        ...
        <div class="navbar-collapse collapse w-100 order-3">
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item my-auto pr-3">
                    <a class="tel"
                       href="tel:<?php echo $cont['kont_cislo']; ?>"><?php echo $cont['kont_cislo']; ?></a><i
    ...
    <section id="about" class="text-center  clearfix">
        <div class="container">
            <div class="intro">
                <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="assets/img/intro.jpg" alt="">
                <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                    <h2 class="section-heading mb-4">
                        <span class="section-heading-upper"><?php echo $cont['title']; ?></span>

                    </h2>
                    <p class="mb-3"><?php echo $cont['onas']; ?>
                    </p>
                    <div class="intro-button mx-auto">
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="#map">Navštivte nás již dnes!</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="product-item">
                <div class="product-item-title d-flex">
                    <div class="bg-faded p-5 d-flex mr-auto rounded">
                        <h2 class="section-heading mb-0">
                            <span class="section-heading-upper">Buďte s námi v kontaktu</span>
                            <span class="section-heading-lower">Kontakt & hodiny</span>
                        </h2>
                    </div>
                </div>
                <div class="product-item-img mx-auto d-flex rounded  mb-3 mb-lg-0">
                    <div class="business-hours mx-auto">
                        <h5 class="title">Otevírací hodiny</h5>
                ...
                <div class="product-item-description d-flex ml-auto">
                    <div class="bg-faded p-5 rounded">
                        <p class="mb-0">V naší pizzerii máte možnost ochutnat nejen pizzu připravovanou na ohni
                            ... <?php echo $cont['title']; ?> je "to
                            nejlepší!"</p>
                        ...
                        <p class="mb-0"><i class="fas fa-mobile"></i><a class="my-auto"
                                                                        href="tel:<?php echo $cont['kont_cislo']; ?>"><?php echo $cont['kont_cislo']; ?></a>
                        </p>
                        <p class="mb-0"><i class="fas fa-at"></i><a href="mailto:<?php echo $cont['kont_email']; ?>"
...
<script>
    ...
    baguetteBox.run('.carousel-block');
    AOS.init();
</script>
